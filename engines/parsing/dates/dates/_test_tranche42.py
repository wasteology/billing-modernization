...
targets = ["Weaver's Sanitation", 'Akat Scrap Metal', 'City of Bakersfield', 'City of Visalia',
           'Shank Waste', "Steve's Sanitation", 'Lemhi Sanitation', 'Weidle Sanitation',
           'Choice Waste Services', 'Hale County Public Works', 'Pike County Solid Waste', 'P&M Reis Trucking']
...
print(f"Testing {len(samples)} vendors from Tranche 42:\n")
passed = 0
failed = 0
