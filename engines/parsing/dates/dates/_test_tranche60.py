...
targets = ['Nisswa Sanitation', 'Jackson County Solid Waste', 'Southeast Waste Disposal', 'Gmen Environmental',
           'City of Sidney', 'United States Disposal', 'North Country Disposal', 'Speedy Dump',
           'McCullough Rubbish', 'Kalamazoo Transfer Station', 'A&C Waste Collection', 'Gilton Solid Waste']
...
print(f"Testing {len(samples)} vendors from Tranche 60:\n")
passed = 0
failed = 0
