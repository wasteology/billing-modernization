...
print(f"Currently configured: {len(configured)} vendors")
print(f"Unconfigured vendors found: {len(unconfigured_counts)}")
print(f"\nTop 15 unconfigured by volume:")
