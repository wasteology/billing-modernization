...
targets = ['Tate Services', 'Local Waste of Upstate', 'Fritz Enterprises', 'Island Recycling',
           'Sphuler Disposal', 'Brookings Dumpster Service', 'Harper Sanitation']
...
print(f"Testing {len(samples)} vendors from Tranche 94:\n")
passed = 0
failed = 0
