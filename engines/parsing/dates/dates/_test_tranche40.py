...
targets = ['Lake Disposal Service', 'Tropical Trash', 'Troupe Waste', 'A&W Iron Metal',
           'Chesapeake Waste', 'Expert Transportation', 'Seadrunar Recycling',
           'Greenbrier Valley Solid Waste', 'BTS Inc', 'Town & Country Disposal',
           'Haul Away Waste', 'Napa Recycling']
...
print(f"Testing {len(samples)} vendors from Tranche 40:\n")
passed = 0
failed = 0
