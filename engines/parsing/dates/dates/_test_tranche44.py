...
targets = ['NVA Services', 'Tahoe Basin Container', 'AWS', 'Boston Baler',
           'City of Foley', 'City of Richardson', 'City of Sallisaw', 'Lincoln County Solid Waste',
           'Norris Sanitation', 'Kamps Pallets', 'Crane Roll-Off', 'Heartland Waste Management']
...
print(f"Testing {len(samples)} vendors from Tranche 44:\n")
passed = 0
failed = 0
