...
targets = ['Mogford Metals', 'Anaconda Disposal', 'Post Environmental Services', 'Virgin Valley Disposal', 'WM Collection', 'American Metal & Paper',
           'United Waste Haulers', 'Walker Garbage and Recycling', 'TNR Hauling', 'City of Yuma', 'Mills Bros', 'Tomorrow RDS']
