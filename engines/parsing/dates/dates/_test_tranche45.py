...
targets = ['City of Tulare', 'Rhino Waste', 'Miller Enterprises', 'City of Mesa',
           'Cowboy Sanitation', 'CWRR', 'City of Fayette', 'Premier Disposal',
           'Nowrush Recycling', 'Seaside Waste', 'City of Temple TX', 'Marin Sanitary']
...
print(f"Testing {len(samples)} vendors from Tranche 45:\n")
passed = 0
failed = 0
