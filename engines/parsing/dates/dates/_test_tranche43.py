...
targets = ['Full Circle Recycling', 'Kohlmorgan Hauling', 'Econo Waste', 'RaeKar',
           'Action Trucking', 'Whites Sanitation', 'Lance Refuse', 'Lift Waste',
           'Long Beach Container', 'Pullman Disposal', 'EZ Disposal', 'Control Waste']
...
print(f"Testing {len(samples)} vendors from Tranche 43:\n")
passed = 0
failed = 0
