...
targets = ['Modern Disposal', 'Bower Disposal', 'Arg Services', 'Sound Disposal Inc',
           'Area Refuse', 'Bozzuto BRS Services', 'City of Winters', 'R&S Waste',
           'WB Waste Solutions', 'All State Waste Inc', 'Perdue Environmental', 'Sanitation One']
...
print(f"Testing {len(samples)} vendors from Tranche 49:\n")
passed = 0
failed = 0
