...
targets = ['City of Cookeville', 'Blue Moon', 'Town & Country Sanitation', 'Waste Reduction Sys',
           'Eastern Waste', 'Junk Solutions', 'Ace Equipment Company', "Dan's Sanitation",
           "Ferrell's Disposal", 'Wayne County Utah', 'U & I Sanitation', 'C&S Disposal']
...
print(f"Testing {len(samples)} vendors from Tranche 58:\n")
passed = 0
failed = 0
