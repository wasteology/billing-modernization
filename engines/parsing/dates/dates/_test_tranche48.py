...
targets = ['Waste Control', 'T-Mac Inc', 'Swinger Sanitation', 'Barbarino Disposal',
           'Bavarian Waste', 'City of Ketchikan', 'Oregon City Garbage', 'Maverick Waste',
           'Gardner Disposal Service', 'Gresham Sanitary Service', 'Douglas Disposal', 'A1 Porta Potty']
...
print(f"Testing {len(samples)} vendors from Tranche 48:\n")
passed = 0
failed = 0
